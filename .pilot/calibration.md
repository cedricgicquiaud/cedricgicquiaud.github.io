...
| Chaque projet a un visuel — livraisons 2/4 « Le build refuse un fichier absent ou lourd » (PFO-60..62) et 3/4 « Page de fiche : galerie, vidéo, image OG » (PFO-63..66) | M + M | 2 sur 4, tuilées | 3 + 4 | 2026-09-05 17:29 | L2 17:43 ; L3 18:04 | 0,75 h de session (17:29 → 18:13) pour les deux ; agents : 0,8 h (1,4 h cumulées sur la feature), 351 échanges | L2 mergée 05/09 18:02 (attente 0,25 h) ; L3 mergée 06/09 00:06 (attente 5,9 h ; conflit UAT.md réassemblé par merge de main dans la branche, 306 tests verts avant push) |
