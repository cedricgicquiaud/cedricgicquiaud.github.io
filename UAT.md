...
- [ ] Contraste : inspecteur sur un paragraphe de l'À propos, `color: rgb(230, 234, 242)` sur `background-color: rgb(11, 18, 32)` ; sur une pastille, `color: rgb(94, 234, 212)`.
- [ ] Image de partage : ouvrir `public/opengraph-image.png`, nom et titre sur le bleu `#7c9bff` (le `--primary` du thème sombre) ; `npm run og` puis `git status` ne montre aucune modification.
